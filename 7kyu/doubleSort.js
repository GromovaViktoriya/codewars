// DESCRIPTION
//Simple enough this one - you will be given an array. The values in the array will either be numbers or strings, or a
// mix of both. You will not get an empty array, nor a sparse one.
//
...
// SOLUTION
function dbSort(a) {
    let stringArr = a.filter(el => typeof el === 'string').sort()
    let numArr = a.filter(el => typeof el !== 'string').sort((a, b) => a - b)
