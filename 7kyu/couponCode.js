...
// For the correct code and the entered code to match, both their values and data types must be the same. This means
// that e.g. false and 0 are not the same, and neither are 123 and "123".
// Examples:
