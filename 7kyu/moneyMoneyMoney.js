...
function calculateYears(principal, interest, tax, desired) {
    ...
    let taxedInterest = accruedInterest * tax;
    let savingsAfterTax = (principal + accruedInterest) - taxedInterest;
    let years = 1;
    while (savingsAfterTax < desired) {
        accruedInterest = savingsAfterTax * interest;
        taxedInterest = accruedInterest * tax;
        savingsAfterTax = (savingsAfterTax + accruedInterest) - taxedInterest;
        years++;
    }
